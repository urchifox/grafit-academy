...
`,h=(e,t,c)=>{let r=e.querySelector(".slider__main-img"),a=e.querySelector(".slider__desc");r.src=c+t.src,a.textContent=t.description},C=(e,t,c)=>{let r=n(F(t,c));e.append(r),r.querySelector(".slider__preview-item").classList.add("slider__preview-item_active"),h(e,t[0],c)};var w=(e,t)=>{e.previewContainer.querySelector(".slider__preview-item_active").classList.remove("slider__preview-item_active");let r=e.picturesData[t];h(e.container,r,e.picturesAddress),e.previewContainer.children[t].classList.add("slider__preview-item_active"),e.currentPreviewIndex=t},P=(e,t)=>{let c=e.target.closest(".slider__arrow");if(!c)return;let r=c.classList.contains("slider__arrow_right")?t.currentPreviewIndex+1:t.currentPreviewIndex-1;r<0&&(r=t.picturesData.length-1),r>t.picturesData.length-1&&(r=0),w(t,r)};function R(e,t){let c=e.target.closest(".slider__preview-btn");if(!c)return;let r=Number(c.dataset.id);w(t,r)}var j=(e,t,c)=>{let r=e.querySelector(".slider-container");C(r,t,c);let a={root:e,container:r,previewContainer:r.querySelector(".slider__previews"),previousBtn:r.querySelector(".slider__arrow_left"),nextBtn:r.querySelector(".slider__arrow_right"),picturesData:t,picturesAddress:c,currentPreviewIndex:0},p=k=>{k.target.closest(".slider__previews")?R(k,a):P(k,a)};r.addEventListener("click",p)};var l=(e,t)=>`
...
`,d=e=>{let t=e.target.closest(".favorite-button"),c=t.querySelector("input"),r=t.dataset.id;c.checked?i.favorites.push(r):i.favorites.splice(i.favorites.indexOf(r),1),localStorage.setItem("favorites",JSON.stringify(i.favorites))};var O=document.querySelector(".pack-market"),A=(e,{packName:t,price:c},r,a)=>`
...
`,q=e=>{let t=e.target.closest(".favorite-button"),c=t.querySelector("input"),r=t.dataset.id,p=document.querySelector(`.pack-card[data-id="${r}"]`).querySelector(".favorite-button input");p.checked=c.checked,d(e)},$=e=>{let t=e.target.closest(".buy-button"),c=t.querySelector("input"),r=t.dataset.id,p=document.querySelector(`.pack-card[data-id="${r}"]`).querySelector(".buy-button input");p.checked=c.checked,f(e)},y=(e,t)=>{let c=i.favorites.includes(e),r=i.inCart.includes(e),a=n(A(e,t,c,r));a.addEventListener("click",L),a.querySelector(".pack-full__close").addEventListener("click",N),a.querySelector('[name="buy"]').addEventListener("click",$),a.querySelector('[name="favorite"]').addEventListener("click",q),document.addEventListener("keydown",S),O.append(a),j(a,t.previews,o),document.body.classList.add("modal-open")},v=()=>{document.querySelector(".pack-full").remove(),document.removeEventListener("keydown",S),document.body.classList.remove("modal-open")};function N(){v()}function S(e){e.key==="Escape"&&v()}function L(e){e.target.classList.contains("pack-full")&&v()}var T=document.querySelector("#cart"),m=T.querySelector(".menu-dropdown__list"),ve=document.querySelector(".pack-market"),g=document.querySelector(".cart__counter"),I=()=>`
  <li class="menu-dropdown__item cart__message">
    \u041A \u0441\u043E\u0436\u0430\u043B\u0435\u043D\u0438\u044E, \u0432 \u0432\u0430\u0448\u0435\u0439 \u043A\u043E\u0440\u0437\u0438\u043D\u0435 \u043F\u043E\u043A\u0430 \u0447\u0442\u043E \u043D\u0435\u0442 \u0442\u043E\u0432\u0430\u0440\u043E\u0432
  </li>
`,U=()=>{let e=n(I());m.append(e)},M=(e,{packName:t,previews:c})=>`
...
`,b=e=>{m.querySelector(".cart__message")?.remove(),g.style.opacity=1;let c=s.get(e),r=n(M(e,c));m.append(r),g.textContent=i.inCart.length},E=e=>{if(m.querySelector(`.menu-dropdown__item[data-id="${e}"]`).remove(),i.inCart.length===0){U(),g.style.opacity=0;return}g.textContent=i.inCart.length};var u=(e,t)=>`
  <label class="buy-button" data-id="${e}">
    <input class="buy-button__checkbox" type="checkbox" name="buy" ${t?"checked":""}/>
    <span class="visually-hidden">\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0443</span>
  </label>
`,f=e=>{let t=e.target.closest(".buy-button"),c=t.querySelector("input"),r=t.dataset.id;c.checked?(i.inCart.push(r),b(r)):(i.inCart.splice(i.inCart.indexOf(r),1),E(r)),localStorage.setItem("inCart",JSON.stringify(i.inCart))};var x=document.querySelector(".packs-list"),D=document.createDocumentFragment(),J=()=>`
  <li class="pack-list-message">
    <p>\u041A \u0441\u043E\u0436\u0430\u043B\u0435\u043D\u0438\u044E, \u043F\u043E \u0432\u0430\u0448\u0435\u043C\u0443 \u0437\u0430\u043F\u0440\u043E\u0441\u0443 \u043D\u0438\u0447\u0435\u0433\u043E \u043D\u0435 \u043D\u0430\u0439\u0434\u0435\u043D\u043E :\u0441</p>
  </li>
`,V=e=>e.map(({src:t})=>`<img src="${o}${t}" alt="" class="pack-card__cover">  `).join(""),W=(e,{packName:t,price:c,previews:r},a,p)=>`
  ...
  </li>`,H=e=>{if(e.target.classList.contains("pack-card__name-link")||e.target.classList.contains("pack-card__cover")){e.preventDefault();let t=e.target.closest(".pack-card").dataset.id,c=s.get(t);y(t,c);return}if(e.target.name==="favorite"){d(e);return}e.target.name==="buy"&&f(e)},Ae=e=>{if(e.length===0){let t=n(J());x.append(t);return}e.forEach(([t,c])=>{let r=i.favorites.includes(t),a=i.inCart.includes(t),p=n(W(t,c,r,a));D.append(p)}),x.addEventListener("click",H),x.append(D)};export{Ae as render};
